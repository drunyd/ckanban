...
> Multi‑project Kanban & bookmark assistant – delivered as a Chrome Extension that replaces your New Tab page with a lightweight, offline board. Current version: **0.5.0**.
